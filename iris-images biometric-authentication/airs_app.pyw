...
class AirsWindow(QtWidgets.QMainWindow, Ui_airsWindow):
    ...
    def onPupilCenterChanged(self):
        ...
        self.pupilCenterAbscissaSpinBox.setValue(int(cx))
        self.pupilCenterOrdinateSpinBox.setValue(int(cy))
    ...
    def onPupilBorderChanged(self):
        ...
        self.pupilBorderAbscissaSpinBox.setValue(int(bx))
        self.pupilBorderOrdinateSpinBox.setValue(int(by))
    ...
    def onIrisCenterChanged(self):
        ...
        self.irisCenterAbscissaSpinBox.setValue(int(ix))
        self.irisCenterOrdinateSpinBox.setValue(int(iy))
    ...
    def onIrisBorderChanged(self):
        ...
        self.irisBorderAbscissaSpinBox.setValue(int(ix))
        self.irisBorderOrdinateSpinBox.setValue(int(iy))
